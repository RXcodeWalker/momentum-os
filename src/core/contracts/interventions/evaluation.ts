...
import type { CooldownAdvisory, SuppressionAdvisory } from "./intelligence";
...
export type InterventionEvaluationContext = {
  ...
  /** Optional intelligence advisories — omitted for fresh users; engine ignores when absent. */
  intelligenceAdvisories?: {
    cooldown: CooldownAdvisory[];
    suppression: SuppressionAdvisory[];
  };
};
