...
export function buildReplay(
  ...
  const { narrative, violations: narrativeViolations } = buildNarrative(
    evidence,
    scope,
    suppressionMap,
    [],
  ...
  const { attribution, violations: attributionViolations } = buildAttribution(
    evidence,
    scope,
    suppressionMap,
    [],
  ...
  const { transitionSummary, violations: transitionViolations } = buildTransitionSummary(
    evidence,
    dynamics,
    scope,
    suppressionMap,
  ...
  const { forecast, violations: forecastViolations } = buildForecast(
    dynamics,
    patterns,
    suppressionMap,
    [],
