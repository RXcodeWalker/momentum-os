...
describe("mergeDirectives", () => {
  ...
  it("boolean deepWorkProtectionEnabled=false via directive: applied", () => {
    ...
    mergeDirectives(
      draft,
      [makeDirective("environmental.deepWorkProtectionEnabled", false)],
      makeNoopRecorder(),
    );
  ...
  it("environmental.interfaceDensity directive: applied", () => {
    ...
    mergeDirectives(
      draft,
      [makeDirective("environmental.interfaceDensity", 90)],
      makeNoopRecorder(),
    );
  ...
  it("guidance.emotionalPressureLevel directive: applied", () => {
    ...
    mergeDirectives(
      draft,
      [makeDirective("guidance.emotionalPressureLevel", 5)],
      makeNoopRecorder(),
    );
