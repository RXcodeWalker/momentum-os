  ...
  MAINTENANCE_LOOP: {
    ...
    signals: [
      ...
      },
      {
        ...
        threshold: 0.4,
        descriptionTemplate:
          "Meaningful progress noted as partial or absent on multiple recent check-ins",
      },
      {
        ...
        threshold: 1,
        descriptionTemplate:
          "Deep work tasks have been rescheduled multiple times without completion",
      },
      {
        ...
        threshold: 0.6,
        descriptionTemplate:
          "Completion activity concentrated in admin and shallow task categories",
      },
    ],
  },
  ...
  PREPARATION_ESCAPE: {
    ...
    signals: [
      ...
      },
      {
        ...
        threshold: 0.5,
        descriptionTemplate:
          "Advancement tasks not initiated in follow-through window after preparation days",
      },
      {
    ...
    signals: [
      {
        ...
        threshold: 20,
        descriptionTemplate:
          "Average estimated task duration is below 20 minutes with high task volume",
      },
      {
      ...
      },
      {
        ...
        threshold: 3,
        descriptionTemplate:
          "High variety of task types observed within single-day completion sets",
      },
    ],
  },
    ...
    signals: [
      {
        ...
        threshold: 0.6,
        descriptionTemplate:
          "Meaningful progress rated absent across the majority of recent check-ins",
      },
      {
      ...
      },
      {
        ...
        threshold: 0.5,
        descriptionTemplate:
          "Completion ratio at acceptable level, suggesting capacity is not the constraint",
      },
      {
