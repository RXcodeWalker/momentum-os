...
import type { InterventionCandidate, InterventionReasoningFactor, SuppressionVerdict, CooldownVerdict } from '../types/internal'
...
): { emotional: string; behavioral: string } {
