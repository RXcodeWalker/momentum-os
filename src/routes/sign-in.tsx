      ...
      >
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          {isUpgradeMode ? (
            ...
            <>
              ...
              <p className="mt-2 text-muted-foreground">
                {isSignUp
                  ? "Start your behavioral evolution."
                  : "Continue your behavioral evolution."}
              </p>
            </>
          )}
        </div>
        ...
        <Card className="p-8 shadow-elegant">
          <Button
            ...
            className="w-full h-12 rounded-xl border border-border bg-background hover:bg-muted transition-all font-medium flex items-center justify-center gap-3 mb-6"
          >
            <GoogleIcon />
        ...
        {!isUpgradeMode && (
          <p className="mt-4 text-center text-xs text-muted-foreground">
            <button type="button" onClick={() => navigate({ to: "/" })} className="hover:underline">
