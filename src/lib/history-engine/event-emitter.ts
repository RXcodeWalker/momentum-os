...
export function emitDistractionLogged(
  types: string[],
): BehavioralEvent<'DISTRACTION_LOGGED'> {
...
export function emitRecoveryExited(
  daysInRecovery: number,
): BehavioralEvent<'RECOVERY_EXITED'> {
...
export function emitReflectionGenerated(
  ...
  return createEvent(
    ...
    { workloadGuidance, confidenceBand },
    'saveCheckIn',
  )
}
